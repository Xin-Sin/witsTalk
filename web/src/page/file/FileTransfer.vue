<template>
  ...
  <el-container>
      <el-aside width="1030px">
        <el-table :data="files" stripe border style="width: 100%;height: auto" highlight-current-row @current-change="handleCurrentChange">
...
import {getFiles,getShowFile} from "../../components/api/requester";
